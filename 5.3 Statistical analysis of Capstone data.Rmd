...
## Climate Stations : Initial Description and Visualization
...
### Description of Climate Stations

The National Centers for Environmental Information ("NOAA") divides Minnesota into 9 Climate Divisions^[1](https://www.ncdc.noaa.gov/monitoring-references/maps/us-climate-divisions.php)^, starting with Climate Division 1 in the northwest, and ending with Climate Division 9 in the southeast.
...
Prior to import, some MRCC datasets contained some observations with no data, which have been removed.
...
### Visualizing the Collected Datasets
...
For the analysis of tempurature extremes, partial years (which do not start on Jan. 1, and/or end on Dec. 31), are removed from the datasets.

Partial years would erroneously skew the min, max, and trend of the data.
